    ...
    <div class="space-y-3">
      ...
      <div class="bg-[#111a22]/60 rounded p-2 mt-2 border border-[#1a2e22]">
        <div class="relative h-4 bg-[#1a2e22] rounded-full overflow-hidden">
          <div class="absolute top-0 bottom-0 left-0 bg-blue-500/40" style={{ width: `${(p().rpm_min / p().rpm_max) * 100}%` }} />
          ...
          <div class="absolute top-0 bottom-0 right-0 bg-orange-500/40" style={{ width: `${((p().rpm_max - p().rpm_rated) / p().rpm_max) * 100}%` }} />
        </div>
